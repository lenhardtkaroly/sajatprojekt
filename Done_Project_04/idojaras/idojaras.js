...
const API_KEY = "f63faa951285c3b123dac8111da71d58"; // API key for OpenWeatherMap API
...
const getWeatherDetails = (cityName, latitude, longitude) => {
    const WEATHER_API_URL = `https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&lon=${longitude}&appid=${API_KEY}&lang=hu`;
